...
Function Send-MailMessageRSH
{
    param(
        $sendto = @("Powershell Master <edeneuve@xxx.com>"),
        [Parameter(mandatory=$true,Valuefrompipline=$true)]
        $list
    )
    $report = @"
<html>
<head>
    ...
    <title>Rapport états des serveurs Windows</title>
        ...
        <tr>
            <td class="navbar" align="center">
                ...
                <table width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr class="navbar">
                        <td ><a class="brand" href="">Etat des Serveurs</a></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td bgcolor="#FFFFFF" align="center">
                <table width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td>
                            <hr>
                            <p>Ce rapport à été générer le <DATE></p>
                        </td>
                    </tr>
                </table>
            </td>
...
"@
    ...
    #foreach($item in $list){
       $tablereport1 = $tablereport1 + [String]::Format($tablereport,"Test","Test")
    #}
    $finalreport = $($report -Replace("<SERVERLIST>",$tablereport1)) -Replace("<Date>",$(Get-Date -f s))
    #$report -Replace("</Date\>",$(Get-Date -f s))
    $sendreport = [String]::Format($report,"test","test")
    Send-MailMessage -From edeneuve@xxx.com  -Encoding UTF8  -SmtpServer xxx.xxx.xxx -Port 25 -Subject $subject -Body $sendreport -To $sendto -BodyAsHtml
}
...
Workflow Get-AdServerUpdate
{
    ...
    $list = ,@{}
        ...
        {
           $UpdateSession = Get-WindowsUpdate -computername $adserver.name
           $workflow:list += New-Object -TypeName PSObject -Property @{
                        Server = $adserver.Name; UpdateMissing = $UpdateSession.Count
                    }
        }
    $list | Send-MailMessageRSH
}
